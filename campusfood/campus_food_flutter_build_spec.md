...
**Backend:** PHP 8.2+ REST API (pure PHP with PDO — no framework)  
**Database:** MySQL 8.0+  
...
```dart
// lib/features/browse/domainModels/vendor.dart
@freezed
...
// lib/features/browse/domainModels/category.dart
@freezed
...
// lib/features/auth/domainModels/user.dart
@freezed
...
// lib/features/browse/domainModels/rating.dart
@freezed
